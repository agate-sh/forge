...
/**
 * All available ACP agents, with priority agents first (Claude Code, Codex CLI, Gemini CLI),
 * followed by the rest alphabetically.
 * Agent definitions are loaded from TOML files in the agents directory.
 */
const PRIORITY_ORDER = ["Claude Code", "Codex CLI", "Gemini CLI"]

export const ACP_AGENTS: ACPAgentDefinition[] = loadAgentsFromToml().sort((a, b) => {
